...
//add background image, with transparent cells
//On left is a square like below link, with the item number -   5 **THEN BELOW** Item(s)
//Name is different color in middle
//Change layout scheme to darker
//http://img193.imageshack.us/img193/2450/picture1zh.png
