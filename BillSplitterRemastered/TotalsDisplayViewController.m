...
- (void)viewDidLoad
{
    ...
    if([[self.extrasDataSource objectForKey:@"how_to_split"] isEqualToString:@"Unevenly"]){ //By default, bill is split unevenly
        ...
        payerTotalObjects = [Calculations performCalculationsWithPayersSplitEvenly:self.payersDataSource andItems:self.itemsDataSource andExtras:self.extrasDataSource];
    }
